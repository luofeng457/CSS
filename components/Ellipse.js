  ...
  return (
    <>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={w} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={h} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={tlv} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={tlh} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={trv} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={trh} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={blv} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={brv} disabled={false} />
        </Col>
      </Row>
      ...
      <Row type="flex" justify="center">
        ...
        <Col span={4} offset={1}>
          <InputNumber min={0} max={350} value={brh} disabled={false} />
        </Col>
      </Row>
    </>
  );
